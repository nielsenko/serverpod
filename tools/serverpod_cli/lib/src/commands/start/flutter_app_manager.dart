...
class FlutterAppManager {
  ...
  Future<void> launch(String appId) async {
    ...
    // Reattach if the previous session left this app's Flutter process
    // alive. Skips the expensive native build. Keyed per app id so apps
    // never read or delete each other's reattach state.
