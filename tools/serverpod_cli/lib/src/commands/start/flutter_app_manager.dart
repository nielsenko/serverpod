...
class FlutterAppManager {
  ...
  /// Whether [launch] can do anything. Apps are configured and listed in every
  /// run mode, but only development launches them.
  bool get canLaunchApps => runMode == 'development';

  /// Launch progress for a presentation layer that shows stages of its own.
  /// Null in the runner, which reports progress as log lines an attached
