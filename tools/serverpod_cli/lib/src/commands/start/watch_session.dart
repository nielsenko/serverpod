...
class WatchSession {
  ...
  /// Arms auto-launch and launches every configured app flagged `auto_launch`
  /// that is not already running.
  ///
  /// Serialized behind any in-flight reload, restart, or migration, and a
  /// no-op once the session is disposed, so a UI attaching during shutdown
  /// cannot spawn a process nothing will clean up.
