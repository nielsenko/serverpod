...
base class ServerpodMcpServer extends MCPServer
  ...
  /// attached. Every tool reports [_notConnectedError] until it is set.
  ///
...
/// The configured Flutter app ids, in configuration order.
List<String> _flutterAppIds(RunnerApi runner) => [
  for (final app in runner.flutterApps) app.id,
];

/// [result]'s message with the MCP-specific retry and follow-up hints appended.
///
...
/// Returns the standard error response for tools whose runner is unset
