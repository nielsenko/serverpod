...
class McpSocketServer {
  ...
  /// Wire the MCP servers to the runner. Can be called before or after clients
  /// connect; already-connected clients are updated in place.
  ...
  /// Shut down the socket server and every connected client.
