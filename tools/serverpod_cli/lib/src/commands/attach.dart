...
/// Returns the runner's attach socket, or throws an [ExitException] saying how
/// to get one.
///
...
/// wherever a manifest leads to an attach: `serverpod runner attach`, and
/// `serverpod start` finding or starting a runner. Without it the empty path
/// reaches
