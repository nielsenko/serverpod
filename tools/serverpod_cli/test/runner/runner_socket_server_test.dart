...
void main() {
  group('Given a runner attach socket,', () {
    ...
    setUp(() async {
      // Short basename keeps the socket path under macOS' sun_path limit.
    ...
    test(
      ...
      () async {
        ...
        // What `status`, `stop`, a second `start` and another worktree's port
        // resolution all do to decide the runner is alive.
