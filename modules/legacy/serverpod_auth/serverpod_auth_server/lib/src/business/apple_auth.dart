...
class AppleAuth {
  static List<Map<String, dynamic>>? _publicKeys;
  ...
  static Future<bool> _verifySignature(JsonWebSignature jws) async {
    for (var publicKey in await _loadPublicKeys()) {
  ...
  static Future<List<Map<String, dynamic>>> _loadPublicKeys() async {
  ...
  @visibleForTesting
  static void resetPublicKeyCache() => _publicKeys = null;
}
