...
import 'package:serverpod_shared/log.dart' as _i36;
...
class Protocol extends _i1.SerializationManagerServer {
    ...
    _i2.TableDefinition(
      ...
      columns: [
        ...
        _i2.ColumnDefinition(
          ...
          columnType: _i2.ColumnType.json,
          isNullable: false,
          dartType: 'package:serverpod_shared/log.dart:LogLevel',
        ),
        _i2.ColumnDefinition(
          name: 'message',
          columnType: _i2.ColumnType.text,
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<List<_i25.QueryLogEntry>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i25.QueryLogEntry>(e))
                    .toList()
    ...
    if (t == _i1.getType<List<_i23.MessageLogEntry>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i23.MessageLogEntry>(e))
                    .toList()
